		...
		*/
		...
		for(int i = 0; i < numOfPips; i++) {
			if(i < 6)
				...
				offset[i] = new Point(1120, 52);
			else if(i == 25)
				offset[i] = new Point(1120, 322);	
			else if(i == 26)
				offset[i] = new Point(518, 52);
			else if(i == 27)
				offset[i] = new Point(518, 322);
		}
...
/*			label[i].setOpaque(true);
			...
			if(i == 24) {
				label[i].setBounds((int) offset[i].getX(), (int) offset[i].getY(), 116, 270);
			}
			else if(i == 25) {
				label[i].setBounds((int) offset[i].getX(), (int) offset[i].getY(), 116, 270);
			}
			else if(i == 26) {
				label[i].setBounds((int) offset[i].getX(), (int) offset[i].getY(), 80, 270);
			}
			else if(i == 27) {
				label[i].setBounds((int) offset[i].getX(), (int) offset[i].getY(), 80, 270);
			}
